    ...
    public void test() {
        running(testServer(3333, fakeApplication(inMemoryDatabase())), HTMLUNIT, new Callback<TestBrowser>() {
            public void invoke(TestBrowser browser) {
                ...
                assertThat(browser.$("header h1").first().getText()).isEqualTo("Play sample application — Delivery database");
                ...
                assertThat(browser.$("section h1").first().getText()).isEqualTo("574 computers found");
                assertThat(browser.$(".alert-message").first().getText()).isEqualTo("Done! Delivery Apple II has been updated");
                ...
                assertThat(browser.$(".alert-message").first().getText()).isEqualTo("Done! Delivery has been deleted");
